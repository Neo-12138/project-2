...
{
    struct input_event in; // linux输入子系统
        ...
        if(in.type == EV_REL) {
            ...
            if(in.code == BTN_MOUSE || in.code == BTN_TOUCH) {
                ...
                switch(in.code) {
                    ...
                    case KEY_PREVIOUS: data->key = LV_KEY_PREV; break;
                    case KEY_NEXT: data->key = LV_KEY_NEXT; break;
...
#if EVDEV_CALIBRATE // 实际坐标值  min 0  m 1024 0  800
